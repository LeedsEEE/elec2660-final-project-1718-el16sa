...
- (void)viewDidLoad {
    ...
    NSURL *WrongSound4 = [NSURL fileURLWithPath:[NSString stringWithFormat:@"%@/Buzzer.wav",[[NSBundle mainBundle] resourcePath]]];
    wrong4 = [[AVAudioPlayer alloc] initWithContentsOfURL:WrongSound4 error:nil];
...
-(void)GameOverMS{
    GameOverViewController *MSecondViewController;
    MSecondViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"GameOverViewController"];
    [self presentViewController:MSecondViewController animated:YES completion:nil];
}
